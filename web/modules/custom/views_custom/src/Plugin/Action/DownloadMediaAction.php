 ...
 * )
 */
class DownloadMediaAction extends ViewsBulkOperationsActionBase implements ViewsBulkOperationsPreconfigurationInterface, ContainerFactoryPluginInterface {
  ...
  public function executeMultiple(array $entities) {
    ...
    $this->tempStore->set('file_paths', $file_paths);
  ...
  protected function generateAndLinkZipFile(array $file_paths, array $failed_file_paths = []) {
    ...
    // $download_url = Url::fromRoute('views_custom.zip_download', ['filename' => basename($zip_path)], ['absolute' => TRUE])->toString();
    $download_url = Url::fromRoute('views_custom.download_media', [], ['absolute' => TRUE])->toString();
